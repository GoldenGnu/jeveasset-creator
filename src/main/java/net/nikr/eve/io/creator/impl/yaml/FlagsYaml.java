...
public class FlagsYaml extends AbstractXmlWriter implements Creator {
	
	private final static Logger LOG = LoggerFactory.getLogger(FlagsYaml.class);
	...
	public String getFilename() {
		return "yaml"+File.separator+"flags.xml";
	}
